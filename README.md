...
In addition to the main workflow, this repository includes several stand-alone functions that reproduce some aspects of the primary scripts without the need for the configuration file or prior file management. These functions may be found in https://github.com/brshipley/megaSDM/Stand-Alone/ along with a README file describing each function. 
