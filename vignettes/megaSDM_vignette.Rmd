...
If you are having trouble downloading the package or running this vignette, please first check https://github.com/brshipley/megaSDM/blob/master/README.md to make sure that you have the package dependencies up-to-date.
